...
export function solicitudCompletadaHtml(params: {
  destinatario: string;
  nombre: string;
  tipo: string;
    ...
    <div style="font-family:Arial,sans-serif;max-width:500px;margin:0 auto;background:#ffffff;border:1px solid #e5e7eb;border-radius:12px;overflow:hidden">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="border-bottom:1px solid #e5e7eb">
        <tr>
          ...
          <td style="padding:18px 24px;vertical-align:middle;text-align:right;white-space:nowrap">
            <span style="font-size:11px;font-weight:700;padding:3px 10px;border-radius:20px;letter-spacing:.4px;text-transform:uppercase;background:#fef9c3;color:#92400e">Pendiente de revisión</span>
          </td>
        </tr>
      </table>
      ...
      <div style="padding:20px 24px">
        <div style="display:flex;align-items:flex-start">
          <div style="width:42px;height:42px;border-radius:50%;background:#fef9c3;flex-shrink:0;font-size:20px;line-height:42px;text-align:center;margin-right:14px">📩</div>
          <div>
            <p style="font-size:15px;font-weight:700;color:#111827;margin:0 0 6px">Hola, ${e(params.destinatario)}</p>
            <p style="font-size:13px;color:#6b7280;margin:0;line-height:1.4">Se adjuntó un documento para la solicitud en <strong style="color:#111827">${e(tituloJerarquia(params.jerarquia))}</strong>. Queda pendiente de tu revisión.</p>
      ...
      <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
          <td width="50%" style="padding:12px 16px;border-bottom:1px solid #e5e7eb;border-right:1px solid #e5e7eb;vertical-align:top">
            <p style="font-size:11px;color:#6b7280;text-transform:uppercase;letter-spacing:.5px;margin:0 0 3px">Solicitud</p>
        ...
        ${params.completadoPor ? `
        <tr>
          <td colspan="2" style="padding:12px 16px;border-bottom:1px solid #e5e7eb;vertical-align:top">
            <p style="font-size:11px;color:#6b7280;text-transform:uppercase;letter-spacing:.5px;margin:0 0 3px">Adjuntado por</p>
            <p style="font-size:14px;font-weight:500;color:#111827;margin:0">${e(params.completadoPor)}</p>
          </td>
        </tr>` : ''}
      </table>
      ...
      <div style="padding:18px 24px">
        ...
        <p style="font-size:12px;color:#6b7280;margin:8px 0 0;line-height:1.4">Recibes este correo porque estás suscrito a las notificaciones de esta empresa/centro/proyecto.</p>
      </div>
