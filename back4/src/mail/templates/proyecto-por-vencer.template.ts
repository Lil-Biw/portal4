...
export function proyectoPorVencerHtml(params: {
  destinatario: string;
  nombre: string;
  fechaFin: string;
    ...
    <div style="font-family:Arial,sans-serif;max-width:500px;margin:0 auto;background:#ffffff;border:1px solid #e5e7eb;border-radius:12px;overflow:hidden">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="border-bottom:1px solid #e5e7eb">
        <tr>
          ...
          <td style="padding:18px 24px;vertical-align:middle;text-align:right;white-space:nowrap">
            <span style="font-size:11px;font-weight:700;padding:3px 10px;border-radius:20px;letter-spacing:.4px;text-transform:uppercase;background:#fef3c7;color:#b45309">Plazo por vencer</span>
          </td>
        </tr>
      </table>
      ...
      <div style="padding:20px 24px">
        <div style="display:flex;align-items:flex-start">
          ...
          <div>
            ...
            <p style="font-size:13px;color:#6b7280;margin:0;line-height:1.4">El proyecto <strong style="color:#111827">${e(tituloJerarquia(params.jerarquia))}</strong> vence en <strong style="color:#b45309">${params.diasRestantes} ${plural}</strong>.</p>
      ...
      <div style="display:flex">
        ...
        <div style="flex:1;padding:12px 16px;border-bottom:1px solid #e5e7eb">
          <p style="font-size:11px;color:#6b7280;text-transform:uppercase;letter-spacing:.5px;margin:0 0 3px">Fecha de término</p>
          <p style="font-size:14px;font-weight:500;color:#111827;margin:0">${e(params.fechaFin)}</p>
        </div>
      </div>
      ...
      <div style="padding:18px 24px">
        ...
        <p style="font-size:12px;color:#6b7280;margin:8px 0 0;line-height:1.4">Recibes este correo por tu preferencia de recordatorio de vencimiento de proyectos.</p>
      </div>
