...
export class AyudaPageComponent {
  ...
  readonly guias: Guia[] = [
    ...
    },
    {
      ...
      pasos: [
        'En "Mantenciones" verás un calendario con las fechas programadas.',
        'Las mantenciones próximas también aparecen en tu panel de Inicio.',
        'Contacta a soporte si una mantención no está registrada.',
      ],
    },
    {
